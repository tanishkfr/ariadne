...
**Nothing in Ariadne installs this.** It is a manual step, it is not automatic, and if you skip it there is no safety net — `git status` discipline is all that stands between you and a committed key.

...
```
You are the Strategist role in my Ariadne. Follow it exactly.
...
Ariadne repository; this copy is non-canonical and exists only because a
...
> **Runtime state file.** Generated by Ariadne, lives at this project's repository root.
...
> `DESIGN.md`, and carries compact reminders of Ariadne policy. If it disagrees with a
...
> Reminder only. Canonical: `WORKFLOW.md` in the Ariadne repository.
...
Do NOT copy Ariadne policies into it. It mirrors decisions and points at

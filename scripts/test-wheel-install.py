...
def self_test() -> int:
    ...
    with workspace() as root:
        ...
        case("fresh Python environment exposes Builder OS version", version_result.stdout.strip() == "Builder OS 1.4.0")
        ...
        expected_runtime = (data_home / "versions" / "1.4.0").resolve()
        case(
        ...
        case(
            ...
            and "Builder OS 1.4.0 is installed" in repair_result.stdout
